...
values (4, 'Loki', 'Strong',
        ...
        false,true);
insert into CHARACTER (ID, CHARACTER_NAME, POWER_TYPE, BIO, HERO,VILLAIN)
values (5, 'Scarlet Witch', 'Very Strong',
...
values (nextval('TEAM_SEQ'), 'Best team NA', 'Combo guys');
insert into team(ID, description, team_name)
values (nextval('TEAM_SEQ'), 'Crime city', 'Do not try to battle us');

insert into team_characters(teams_id,characters_id)
values (1,2);
insert into team_characters(teams_id,characters_id)
values (1,3);
insert into team_characters(teams_id,characters_id)
...
INSERT INTO USER (ID, USERNAME, PASSWORD, ROLE) VALUES
    (nextval('USER_SEQ'), 'marie',
     ...
     'USER');
INSERT INTO USER (ID, USERNAME, PASSWORD, ROLE) VALUES
    (nextval('USER_SEQ'), 'Bob',
     '$2a$10$9TeBFudS7HsgCa4sSvP//O627sMq.KiTFrOr8IzrVlYw5c8aoKzNm', 'USER');
insert into team(ID, description, team_name, USER_ID)
values (nextval('TEAM_SEQ'), 'Test personal team', 'My only team',3);